    ...
    public class PlaySceneInspectorEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty modeProp =
                serializedObject.FindProperty(nameof(PlayScene.testMode));
            ...
            if (modeProp.enumValueIndex == (int)PlayScene.TestMode.Multi)
            {
                SerializedProperty subProp =
                    serializedObject.FindProperty(nameof(PlayScene.multiMode));

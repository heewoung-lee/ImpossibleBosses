...
namespace Skill.AllofSkills.Fighter
{
    public class SkillBuffRoar : SkillDuration
    {
        ...
        public override Sprite SkillconImage =>
            _resourcesLoader.Load<Sprite>("Art/Player/SkillICon/WarriorSkill/SkillIcon/Roar");
        ...
        public override void SkillAction()
        {
            ...
            _bufferManager.ALL_Character_ApplyBuffAndCreateParticle(_players,
                (playerNgo) =>
                {
                    Managers.VFXManager.GenerateParticle("Prefabs/Player/SkillVFX/Aura_Roar", playerNgo.transform,
                        SkillDurationTime);
                }
                ,
                () =>
